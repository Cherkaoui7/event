...
const PageLoader = () => (
  <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh', color: '#b76e4b', fontFamily: 'Poppins, sans-serif' }}>
    <div style={{ textAlign: 'center' }}>
      <div style={{ width: '50px', height: '50px', border: '4px solid #efe3d3', borderTopColor: '#b76e4b', borderRadius: '50%', animation: 'spin 1s linear infinite', margin: '0 auto 15px' }}></div>
      <style>{`@keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }`}</style>
      <h3 style={{ margin: 0 }}>Chargement de l'expérience...</h3>
      <p style={{ color: '#7d8c7a', fontSize: '0.9rem' }}>Préparation des éléments graphiques</p>
    </div>
  </div>
);
