                ...
                <tr key={u.id} style={s.tr}>
                  ...
                  <td style={s.td}>
                    <span
                      style={{
                        ...s.badge,
                        background: u.role === "admin" ? "#b76e4b" : "#7d8c7a",
                      }}
                    >
                      {u.role}
                    </span>
            ...
            <tbody>
              {events.map((ev) => (
                <tr key={ev.id} style={s.tr}>
                  ...
                  <td style={s.td}>
                    <span style={{ ...s.typeBadge }}>{ev.event_type}</span>
                  </td>
                  <td style={s.td}>
                    <span
                      style={{
                  ...
                  <td style={s.td}>
                    <strong>
                      {Number(ev.total_price).toLocaleString("fr-FR")} MAD
                    </strong>
                  </td>
                </tr>
              ))}
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 30 }}>
      ...
      <div style={s.kpiGrid}>
        <KpiCard
          ...
          sub={`${kpis.adminCount} admins · ${kpis.clientCount} clients`}
          color="#b76e4b"
        />
        <KpiCard
          icon="📅"
          ...
          sub={`~${kpis.avgGuests} invités / événement`}
          color="#7d8c7a"
        />
        <KpiCard
          icon="💰"
          label="Revenu total"
          value={fmtMAD(kpis.totalRevenue)}
          sub="Toutes les réservations"
          color="#d4a373"
        />
        <KpiCard
          icon="📈"
          ...
          value={
            kpis.totalEvents
              ? fmtMAD(kpis.totalRevenue / kpis.totalEvents)
              : "0 MAD"
          }
          sub="Par événement"
          color="#264653"
        ...
        <ChartCard title="Inscriptions mensuelles">
          <ResponsiveContainer width="100%" height={280}>
            ...
            >
              ...
              <YAxis
                allowDecimals={false}
                tick={{ fill: "#5a4a3f", fontSize: 12 }}
              />
              <Tooltip
                formatter={(v) => [`${v} utilisateur(s)`, "Inscriptions"]}
              />
